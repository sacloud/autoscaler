...
type ScalingServiceClient interface {
	...
	// Keep 台数維持のリクエスト
	Keep(ctx context.Context, in *ScalingRequest, opts ...grpc.CallOption) (*ScalingResponse, error)
}
...
func (c *scalingServiceClient) Keep(ctx context.Context, in *ScalingRequest, opts ...grpc.CallOption) (*ScalingResponse, error) {
	out := new(ScalingResponse)
	err := c.cc.Invoke(ctx, "/autoscaler.ScalingService/Keep", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ScalingServiceServer interface {
	...
	// Keep 台数維持のリクエスト
	Keep(context.Context, *ScalingRequest) (*ScalingResponse, error)
...
func (UnimplementedScalingServiceServer) Keep(context.Context, *ScalingRequest) (*ScalingResponse, error) {
...
func _ScalingService_Keep_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ScalingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ScalingServiceServer).Keep(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/autoscaler.ScalingService/Keep",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ScalingServiceServer).Keep(ctx, req.(*ScalingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ScalingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Keep",
			Handler:    _ScalingService_Keep_Handler,
		},
	},
