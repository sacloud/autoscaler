...
type Server struct {
	...
	AssignedNetwork *NetworkInfo         `protobuf:"bytes,8,opt,name=assigned_network,json=assignedNetwork,proto3" json:"assigned_network,omitempty"` // TODO その他渡すパラメータを整理する
}
...
var file_handler_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x5f, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b,
